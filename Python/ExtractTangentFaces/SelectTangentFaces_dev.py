...
"""
for selection
User selects surfaces.
Add all to a brep.
Use the tangent face finder.
Options = Angle, Join, Copy
See if the brep face idx == the idx of the input surfaces, 
if so, use this to map back to the input list and join
these as the result.
