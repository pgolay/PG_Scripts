...
def InterpolatePolyline():
    ...
    for pLineId in ids:
        ...
        """
        Straightness ratio is used to determine wheather the polyline before or after  a point.
        Lower ratios will result in hard corners appearing more often
        ...
        """
            ...
            start a new set, still using the current point, move to the next point.
        ...
        rs.ObjectLayer(newCrvs, rs.CurrentLayer())
