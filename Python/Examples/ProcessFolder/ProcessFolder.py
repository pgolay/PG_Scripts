    ...
    for file in rList:
        ...
        for view in views:
            ...
            if type(view) == Rhino.Display.RhinoPageView:
                ...
                break
        if layout:
            rs.Command ("_-Print _Setup _View _AllLayouts _Enter _Destination _Printer " + printerName + " _Enter _Enter _Go " + file.replace("3dm", "pdf")  + " _Enter")
        pass
